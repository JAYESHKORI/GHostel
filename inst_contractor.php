...
$dp_path="images/profile_pics/$dob$extension";

$sql = mysqli_query($connection,"INSERT INTO `cntnContractorData` (`contractorid`, `first_name`, `last_name`, `middle_name`, `dob`, `email`, `contact`, `address`, `em_contact`, `hostelid`, `blockid`, `username`, `password`, `dp_path`) VALUES 
...
if($sql)
{
	...
	echo json_encode(array('response'=>'New Contractor Added Successfully'));
}
else
{
