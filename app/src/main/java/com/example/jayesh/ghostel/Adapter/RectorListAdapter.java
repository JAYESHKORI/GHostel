...
import com.example.jayesh.ghostel.Activity.EditRectorActivity;
...
public class RectorListAdapter extends RecyclerView.Adapter<RectorListAdapter.MyViewHolder>
{
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            switch (item)
                            {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    view.getContext().startActivity(new Intent(view.getContext(),EditRectorActivity.class)
                                            .putExtra("rectorid",commonData.get(pos).getId()));
                                    break;
                                case 2:
    ...
    public RectorListAdapter(Context context, ArrayList<CommonData> commondata) {
        this.caller = context;
    ...
    @Override
    public void onBindViewHolder(RectorListAdapter.MyViewHolder holder, final int position)
    {
    ...
    private void showwarning(String title, String msg, final int rectorid)
    {
        ...
        alertDialog.setButton(android.support.v7.app.AlertDialog.BUTTON_POSITIVE, "Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                deleteStudent(rectorid);
            }
        });
        alertDialog.show();
    }

    private void deleteStudent(final int rectorid) {
