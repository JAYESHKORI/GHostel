...
public class StudentListAdapter extends RecyclerView.Adapter<StudentListAdapter.MyViewHolder>
{
    ...
    public StudentListAdapter(Context context, ArrayList<CommonData> commondata) {
        this.caller = context;
    ...
    @Override
    public void onBindViewHolder(StudentListAdapter.MyViewHolder holder, final int position)
    {
