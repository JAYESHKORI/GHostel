...
public class EditRectorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_rector);
    ...
    private void editRectorInfo()
    {
        final ProgressDialog progressDialog = new ProgressDialog(EditRectorActivity.this);
        progressDialog.setMessage("Loading...");
        progressDialog.show();

        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.API_URL
                + Const.API_EDITRECTOR,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(EditRectorActivity.this);
    ...
    {
        AlertDialog alertDialog = new AlertDialog.Builder(EditRectorActivity.this).create();
