...
public class AdminAddStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bitmap = BitmapFactory.decodeResource(AdminAddStudent.this.getResources(), R.mipmap.ic_dp);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    {
                        AlertDialog alertDialog = new AlertDialog.Builder(AdminAddStudent.this).create();
    ...
    private void addStudent()
    {
        if(et_enroll.getText().toString().equals(""))
            Toast.makeText(AdminAddStudent.this,"Enrollment No. Required",Toast.LENGTH_SHORT).show();
        else if(et_fname.getText().toString().equals(""))
            Toast.makeText(AdminAddStudent.this,"First name Required",Toast.LENGTH_SHORT).show();
        else if(et_lname.getText().toString().equals(""))
            Toast.makeText(AdminAddStudent.this,"Last name Required",Toast.LENGTH_SHORT).show();
        else if(et_mname.getText().toString().equals(""))
            Toast.makeText(AdminAddStudent.this,"Middle name Required",Toast.LENGTH_SHORT).show();
        else if(tv_dob.getText().toString().equals(""))
            Toast.makeText(AdminAddStudent.this,"Date of Birth Required",Toast.LENGTH_SHORT).show();
        else if(et_email.getText().toString().equals(""))
            Toast.makeText(AdminAddStudent.this,"Email Required",Toast.LENGTH_SHORT).show();
        else if(et_contact.getText().toString().equals("")||et_contact.getText().toString().length()!=10)
            Toast.makeText(AdminAddStudent.this,"Contact Required",Toast.LENGTH_SHORT).show();
        else if(et_address.getText().toString().equals(""))
            Toast.makeText(AdminAddStudent.this,"Address Required",Toast.LENGTH_SHORT).show();
        else if(et_parentcontact.getText().toString().equals("")||et_parentcontact.getText().toString().length()!=10)
            Toast.makeText(AdminAddStudent.this,"Parent contact Required",Toast.LENGTH_SHORT).show();
        else if(et_em_contact.getText().toString().equals("")||et_em_contact.getText().toString().length()!=10)
            Toast.makeText(AdminAddStudent.this,"Emergency contact Required",Toast.LENGTH_SHORT).show();
        else if(et_college.getText().toString().equals(""))
            Toast.makeText(AdminAddStudent.this,"College Required",Toast.LENGTH_SHORT).show();

        else
        {
            final ProgressDialog progressDialog = new ProgressDialog(AdminAddStudent.this);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                Toast.makeText(AdminAddStudent.this,response,Toast.LENGTH_LONG).show();
                                ...
                                startActivity(new Intent(AdminAddStudent.this,AdminActivity.class));
                                finish();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(AdminAddStudent.this);
    ...
    private void getDob()
    {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(AdminAddStudent.this,
