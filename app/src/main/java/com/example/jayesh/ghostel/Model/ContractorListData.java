...
public class ContractorListData
{
    private int id;
    ...
    public ContractorListData(int id, String fname, String lname, String mname, String dob, String email, long contact, String address, long em_contact, int hostelid, int blockid, String username, String password, String dp_path) {
        this.id = id;
        this.fname = fname;
        this.lname = lname;
        this.mname = mname;
