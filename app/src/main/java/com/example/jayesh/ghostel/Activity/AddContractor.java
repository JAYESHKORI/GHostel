...
public class AddContractor extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_mname = (EditText)findViewById(R.id.addCont_et_mname);
        tv_dob = (TextView)findViewById(R.id.addCont_tv_dob);
        ...
        et_email = (EditText)findViewById(R.id.addCont_et_email);
        et_contact = (EditText)findViewById(R.id.addCont_et_contact);
        et_address = (EditText)findViewById(R.id.addCont_et_address);
        et_em_contact = (EditText)findViewById(R.id.addCont_et_em_contact);
        iv_dp = (ImageView)findViewById(R.id.addCont_iv_dp);
        ...
        spn_hostel = (Spinner)findViewById(R.id.addCont_spn_hostel);
        ...
        spn_block = (Spinner)findViewById(R.id.addCont_spn_block);
        btn_add = (Button)findViewById(R.id.addCont_btn_add);
